...
public class ObjectsRepositoryView extends ViewPart {

	public static final String ID = "test.graphiti.nonemf.rcpapp.ObjectsRepositoryView"; //$NON-NLS-1$
	private final FormToolkit toolkit = new FormToolkit(Display.getCurrent());

	public ObjectsRepositoryView() {
	}
...
//			treeViewer.addDropSupport(operations, transferTypes, new DropListener(treeViewer));
			...
			treeViewer.setInput(DataModelProvider.INSTANCE.getModel());
		}
