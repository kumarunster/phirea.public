...
import test.graphiti.nonemf.rcpapp.draganddrop.DataModelProviderDnD;
import test.graphiti.nonemf.rcpapp.draganddrop.DragListener;
import test.graphiti.nonemf.rcpapp.draganddrop.DropListener;
import test.graphiti.nonemf.rcpapp.draganddrop.TreeContentProvider;
import test.graphiti.nonemf.rcpapp.draganddrop.TreeLabelProvider;

public class ObjectsRepositoryViewDnD extends ViewPart {


	public static final String ID = "test.graphiti.nonemf.rcpapp.ObjectsRepositoryViewDnD"; //$NON-NLS-1$
	private final FormToolkit toolkit = new FormToolkit(Display.getCurrent());

	public ObjectsRepositoryViewDnD() {
	}
	...
	public void createPartControl(Composite parent) {
		...
		{
      TreeViewer treeViewer = new TreeViewer(container, SWT.FULL_SELECTION );
...
//      treeViewer.addDropSupport(operations, transferTypes, new DropListener(treeViewer));
      ...
      treeViewer.setInput(DataModelProviderDnD.INSTANCE.getModel());
    }
